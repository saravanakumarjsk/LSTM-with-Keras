...
fname="C:\\Users\\jana\\Desktop\\multi step\\AMZN.csv"
...
np.random.seed (seed)
fit1 = Sequential ()
fit1.add (LSTM (  1000 , activation = 'tanh', inner_activation = 'hard_sigmoid' , input_shape =(len(cols), 1) , return_sequences = True))
fit1.add (LSTM (  2000, return_sequences = True))
fit1.add(Dropout(0.2))
fit1.add (LSTM (  3000, return_sequences = False))
fit1.add(Dropout(0.2))
